...
OUTPUT_RESULTS_JSON = "intermediate_qubo_results.json"
OUTPUT_SUMMARY_JSON = "intermediate_qubo_summary.json"
...
def run_qubo_experiment():
    ...
    print("=" * 80)
    print(f"QUBO SOLVER — INTERMEDIATE CASE (n = {N}, L = {L})")
    print("=" * 80)
